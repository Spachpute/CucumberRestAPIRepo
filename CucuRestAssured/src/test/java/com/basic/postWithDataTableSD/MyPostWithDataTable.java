...
public class MyPostWithDataTable {
	...
	public void user_hit_the_post_request_with_json_data(String username) throws IOException{
		...
		//Read data from file
		String data = ""; 
	    data = new String(Files.readAllBytes(Paths.get("E:\\Radical\\23-june-2019\\sd\\postWithDataTableSD\\user.json"))); 
	...
	public void user_validate_following_data(DataTable table){
